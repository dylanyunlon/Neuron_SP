...
from deepspeed.core.dist_checkpointing import ShardedTensor
from deepspeed.core.dist_checkpointing.mapping import ReplicaId, ShardedTensorFactory
from deepspeed.core.inference.contexts import BaseInferenceContext, DynamicInferenceContext
from deepspeed.core.inference.contexts.attention_context.triton.tensor_ops import (
    tensor_get_slice_after,
    tensor_masked_update,
    tensor_merge,
)
from deepspeed.core.inference.utils import InferenceMode
...
from deepspeed.core.ssm.ops.causal_conv1d_triton import causal_conv1d_update
from deepspeed.core.ssm.ops.mamba_ssm import selective_state_update
from deepspeed.core.tensor_parallel import get_cuda_rng_tracker
from deepspeed.core.transformer import TransformerConfig
...
try:
    from deepspeed.core.ssm.ops.ssd_combined import mamba_chunk_scan_combined_varlen
...
class MambaMixer(MegatronModule):
    ...
    def _ssm_prefill(
        ...
        if conv_state is not None and is_dynamic_batching:
            ...
            from deepspeed.core.ssm.ops.causal_conv1d_varlen import causal_conv1d_varlen_fn
