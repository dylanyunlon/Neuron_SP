...
from deepspeed.core.dist_checkpointing.utils import apply_prefix_mapping
from deepspeed.core.inference.contexts import BaseInferenceContext
...
from deepspeed.core.transformer.enums import CudaGraphModule, InferenceCudaGraphScope
...
from deepspeed.core.typed_torch import apply_module
from deepspeed.core.utils import deprecate_inference_params
...
class MambaLayer(GraphableMegatronModule):
    ...
    def create_mcore_cudagraph_manager(self, config):
        ...
        from deepspeed.core.transformer.cuda_graphs import CudaGraphManager
