...
from deepspeed.core.datasets.blended_megatron_dataset_config import BlendedMegatronDatasetConfig
from deepspeed.core.datasets.indexed_dataset import IndexedDataset
from deepspeed.core.datasets.megatron_dataset import MegatronDataset
from deepspeed.core.datasets.object_storage_utils import ObjectStorageConfig, is_object_storage_path
...
class GPTDataset(MegatronDataset):
    ...
    def _build_document_sample_shuffle_indices(
        ...
        if not path_to_cache or (
            ...
            from deepspeed.core.datasets import helpers
