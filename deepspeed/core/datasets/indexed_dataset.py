...
from deepspeed.core.datasets.object_storage_utils import S3Config  # pylint: disable=unused-import
from deepspeed.core.datasets.object_storage_utils import (
    ObjectStorageConfig,
    cache_index_file,
    dataset_exists,
...
from deepspeed.core.msc_utils import MultiStorageClientFeature
