...
try:
    ...
    from deepspeed.core.distributed.fsdp.src.megatron_fsdp.param_and_grad_buffer import (
        make_fsdp_dtensor,
    )
    from deepspeed.core.distributed.fsdp.src.megatron_fsdp.uneven_dtensor import (
        split_dtensor,
        uneven_dtensor_to_full_tensor,
    )
    from deepspeed.core.distributed.fsdp.src.megatron_fsdp.utils import (
...
from deepspeed.core.tensor_parallel.layers import copy_tensor_model_parallel_attributes
from deepspeed.core.transformer.transformer_layer import TransformerLayer
from deepspeed.core.utils import get_attr_wrapped_model
