...
# Ported from Megatron-LM megatron/core/transformer/moe/fused_a2a.py

from typing import Optional

# ---------------------------------------------------------------------------
# Local replacement for megatron.core.utils.internal_api.
# Marks a function/class as an internal (non-public) API; purely informational.
# ---------------------------------------------------------------------------
...
def internal_api(func):
    ...
    Objects decorated with this are exempt from backward-compatibility checks.
    This is a lightweight local replacement for megatron.core.utils.internal_api.
    """
