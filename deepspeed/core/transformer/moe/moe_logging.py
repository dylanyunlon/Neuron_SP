...
# Ported from Megatron-LM megatron/core/transformer/moe/moe_logging.py
...
class MoEMetricsTracker:
    ...
    def report(
        ...
        Args:
            ...
            total_loss_dict: Training-loop accumulator.  Metrics
        ...
        # Accumulate loss metrics into total_loss_dict
