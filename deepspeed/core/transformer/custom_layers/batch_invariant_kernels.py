...
try:
    ...
    from deepspeed.core.utils import null_decorator
...
def _te_patch_for_batch_invariant():
    ...
    import deepspeed.core.extensions.transformer_engine as meg_te
...
def _te_unpatch_for_batch_invariant():
    ...
    meg_te = _import_module_if_available("deepspeed.core.extensions.transformer_engine")
    if (
        meg_te is not None
