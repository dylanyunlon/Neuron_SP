...
from deepspeed.core.extensions.transformer_engine import HAVE_TE
from deepspeed.core.models.common.embeddings import (
    RotaryEmbedding,
    YarnRotaryEmbedding,
    _yarn_get_mscale,
...
from deepspeed.core.transformer.attention import Attention
...
from deepspeed.core.utils import deprecate_inference_params, get_pg_size

try:
    from deepspeed.core.fusions.fused_mla_yarn_rope_apply import (
...
if HAVE_TE:
    ...
    from deepspeed.core.post_training.modelopt.layers import Linear
else:
...
class AbsorbedMLASelfAttention(Attention):
    ...
    def set_for_recompute_input_layernorm(self):
        ...
        from deepspeed.core.extensions.transformer_engine import set_save_original_input
