...
from deepspeed.core.dist_checkpointing.utils import replace_prefix_for_sharding
from deepspeed.core.enums import Fp4Recipe, Fp8Recipe
...
from deepspeed.core.quantization.quant_config import QuantizationConfig
from deepspeed.core.quantization.utils import get_quant_config_or_none
from deepspeed.core.tensor_parallel.layers import (
    _initialize_affine_weight_cpu,
    set_tensor_model_parallel_attributes,
)
from deepspeed.core.tensor_parallel.mappings import gather_from_tensor_model_parallel_region
from deepspeed.core.tensor_parallel.random import (
    get_cuda_rng_tracker,
    get_data_parallel_rng_tracker_name,
    get_expert_parallel_rng_tracker_name,
)
from deepspeed.core.tensor_parallel.utils import divide
from deepspeed.core.transformer.enums import AttnMaskType
from deepspeed.core.transformer.mlp import MLP, MLPSubmodules
from deepspeed.core.transformer.torch_norm import LayerNormInterface
...
from deepspeed.core.typed_torch import copy_signature
...
def _get_fp8_model_init_for_quant_recipe(qrecipe: TEQuantizationRecipe):
    if qrecipe.fp8_quantization_recipe is None and qrecipe.fp4_quantization_recipe is None:
        ...
        if qrecipe.fp8_quantization_recipe == Fp8Recipe.custom:
            from deepspeed.core.fp8_utils import _get_custom_recipe
...
class TELMHeadColumnParallelLinear(TEColumnParallelLinear):
    ...
    def __init__(
        ...
        *,
        ...
        from deepspeed.core.fp8_utils import is_mxfp8_output_proj_active
...
if HAVE_TE and is_te_min_version("1.9.0.dev0"):
    ...
    class TEGroupedLinear(te.pytorch.GroupedLinear):
        ...
        def _decode_extra_state(self, state):
            from deepspeed.core.safe_globals import SafeUnpickler
