...
from deepspeed.core import config
from deepspeed.core._rank_utils import log_single_rank
from deepspeed.core.package_info import __version__ as mcore_version
...
def drain_embedding_wgrad_compute(
    ...
    from deepspeed.core.parallel_state import get_global_memory_buffer
...
def unwrap_model(model, module_instances=None):
    ...
    if module_instances is None:
        from deepspeed.core.distributed import DistributedDataParallel as DDP
        from deepspeed.core.distributed import TorchFullyShardedDataParallel as torch_FSDP
        from deepspeed.core.distributed.fsdp.mcore_fsdp_adapter import (
            FullyShardedDataParallel as megatron_FSDP,
        )
        from deepspeed.core.transformer.module import Float16Module
