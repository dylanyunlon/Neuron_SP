...
# Source: megatron/optimizer/__init__.py (NVIDIA/Megatron-LM commit 7dc8c4759)
# Author: Lawrence McAfee <lmcafee@nvidia.com>  Date: 2022-02-09
#
# Mapping: megatron/optimizer/__init__.py → deepspeed/compile/megatron_optimizer_init.py
#          (project convention: megatron top-level → deepspeed/compile/)
#
# Changes ported from __init__.py:
#   1. In get_megatron_optimizer(), after the get_param_groups() call,
#      inserted commented-out pax debug block (lutil introspection of
...
from .megatron_optimizer import Float16OptimizerWithFloat16Params, FP32Optimizer
from .megatron_optimizer import ConstantGradScaler, DynamicGradScaler
...
def get_megatron_optimizer(model, no_weight_decay_cond=None, scale_lr_cond=None, lr_mult=1.0):
    ...
    if args.fp16 or args.bf16:
        ...
        return Float16OptimizerWithFloat16Params(optimizer, args.clip_grad,
                                                 ...
                                                 args.use_contiguous_buffers_in_local_ddp, args.bf16,
                                                 grad_scaler)
