...
class BalancedCPScheduler:
    ...
    def __init__(self, max_seq_len_per_rank: int, dp_cp_group: torch.distributed.ProcessGroup):
        ...
        print(f"[DES-LOC] BalancedCPScheduler init: max_seq_len_per_rank={max_seq_len_per_rank}, "
              f"total_hdp_gpus={self.total_hdp_gpus}, "
              f"dp_cp_group_size={dp_cp_group.size()}")
